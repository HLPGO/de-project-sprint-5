...
from examples.stg.order_system_restaurants_dag.pg_saver_order import PgSaver_order
...
class OrderLoader:
    ...
    def __init__(self, collection_loader: OrderReader, pg_dest: PgConnect, pg_saver: PgSaver_order, logger: Logger) -> None:
