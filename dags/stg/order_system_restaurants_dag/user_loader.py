...
from examples.stg.order_system_restaurants_dag.pg_saver_user import PgSaver_user
...
class UserLoader:
    ...
    def __init__(self, collection_loader: UserReader, pg_dest: PgConnect, pg_saver: PgSaver_user, logger: Logger) -> None:
